...
//				String result=Jsoup.connect(url).ignoreContentType(true).execute().body();
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10000; i++) {
            String urlWeibo = "http://m.weibo.cn/container/getIndex?uid=2351693951&luicode=10000011&lfid=1076032351693951&sudaref=m.spider.cn&retcode=6102&type=uid&value=2351693951&containerid=1076032351693951";
...
//		String url="http://s.weibo.com/user/%25E4%25B8%258D%25E6%258B%2594%25E5%2585%2585%25E7%2594%25B5%25E5%2599%25A8&Refer=index";
            System.out.println(getDocument(urlWeibo));
